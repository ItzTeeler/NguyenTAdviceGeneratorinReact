    ...
    return (
        <>
            <div className="h-[100vh] bg-[#1f2632] grid justify-items-center items-center">
                <div className="bg-[#323a49] grid justify-items-center items-center gap-4 px-6 pt-10 pb-20 max-w-[32rem] mx-auto max-sm:mx-[20px] rounded-[10px] relative">

                    <h3 className="text-[#52ffa8] text-[15px] text-center font-semibold tracking-[5px]">ADVICE #{props.id}</h3>

                    <p className="text-[28px] leading-snug text-[#cee3e9] text-center font-semibold">"{props.advice}"</p>
